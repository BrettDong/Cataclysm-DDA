...
TEST_CASE( "revolver_reload_option", "[reload],[reload_option],[gun]" )
{
    ...
    const item_reload_option gun_option( &dummy, gun, ammo );
    ...
    const item_reload_option speedloader_option( &dummy, speedloader, ammo );
    ...
    const item_reload_option gun_speedloader_option( &dummy, gun, speedloader );
...
TEST_CASE( "magazine_reload_option", "[reload],[reload_option],[gun]" )
{
    ...
    const item_reload_option magazine_option( &dummy, magazine, ammo );
    ...
    const item_reload_option gun_option( &dummy, gun, magazine );
...
TEST_CASE( "belt_reload_option", "[reload],[reload_option],[gun]" )
{
    ...
    const item_reload_option belt_option( &dummy, belt, ammo );
    ...
    const item_reload_option gun_option( &dummy, gun, belt );
...
TEST_CASE( "canteen_reload_option", "[reload],[reload_option],[liquid]" )
{
    ...
    const item_reload_option bottle_option( &dummy, bottle, water_bottle );
    ...
    const item_reload_option canteen_option( &dummy, canteen, water_bottle );
